...
--trazendo a user base do mes anterior para uma determinada forma de pagamento (vai ter replicação em tipo de campanha)
LEFT JOIN (select 
dc.pay_method_name
...
#obs: modelo sem o resultado do primeiro mês tem dificuldades para prever (r2 = 0.3863)
print(r2)
print(mabe)
#%%visualizar o predito e realizado
#comparacao = pd.DataFrame(zip(y_test['GUV_M6_ACUM'], y_predicted), columns =['test', 'prediction'])
#comparacao.to_csv('C:/Users/FlaviaCosta/Google Drive/Projeções/comparacao.csv')
...
#%% unificar previsão e dados das campanhas
dataset_aplicacao['FORECAST_GUV_M6_ACUM'] = y_forecast
#tratamentos
dataset_aplicacao.loc[dataset_aplicacao['FORECAST_GUV_M6_ACUM'] <= dataset_aplicacao['GUV_M1_ACUM'], 'FORECAST_GUV_M6_ACUM_F'] = dataset_aplicacao['GUV_M1_ACUM'] * 6
dataset_aplicacao.loc[dataset_aplicacao['FORECAST_GUV_M6_ACUM'] > dataset_aplicacao['GUV_M1_ACUM'], 'FORECAST_GUV_M6_ACUM_F'] = dataset_aplicacao['FORECAST_GUV_M6_ACUM']
dataset_aplicacao['PAG_6_MESES'] = dataset_aplicacao['FORECAST_GUV_M6_ACUM_F'] > dataset_aplicacao['GASTO']
dataset_aplicacao.loc[dataset_aplicacao['GUV_M6_ACUM'] > 0, 'FORECAST_GUV_M6_ACUM_F'] = dataset_aplicacao['GUV_M6_ACUM']

#%% Exportação
dataset_aplicacao.to_csv('C:/Users/FlaviaCosta/Google Drive/Projeções/resultados_roi_6m.csv')
