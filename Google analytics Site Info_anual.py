# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 10:34:30 2020
...
#INPUT - DATAS
#START_DATE = '2020-01-01' #fixo YTD
#END_DATE   = '2020-07-31'
START_DATE = (datetime.today() + relativedelta(months=-1)).strftime('%Y-01-01')
END_DATE = until
...
def export_df(df):
    df.to_csv("export_data_view_anual_" + VIEW_ID + "_" + END_DATE + ".csv")   
